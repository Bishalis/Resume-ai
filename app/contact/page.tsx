  ...
  return (
    <div className="h-[100vh] flex items-center justify-center  lg:justify-around">
      <div className=" flex gap-x-20 flex-col">
        <h1 className="font-extrabold  leading-snug text-4xl text-green-700 text-center">
        ...
        >
          ...
          />
          <input name="Email" placeholder="Enter your Email " className="rounded-sm p-2 border-b-2 border-gray-200" required/>
          <textarea
            name=""
            id=""
